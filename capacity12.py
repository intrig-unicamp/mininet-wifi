...
from mininet.wifi import phyInterface, station
...
def topology():
    "Create a network."
    net = Mininet( wirelessRadios=12, waitTime=10, controller=Controller, link=TCLink, switch=OVSKernelSwitch )
