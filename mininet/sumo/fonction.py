...
def noChangeSaveTimeAndSpeed(Visited, ListVeh, time, speed, vehID):
    ...
    if Visited[ListVeh.index(vehID)] == traci.vehicle.getRoadID(vehID) or (
                Visited[ListVeh.index(vehID)] != traci.vehicle.getRoadID(vehID)) and not (
                traci.vehicle.getRoadID(vehID) in traci.vehicle.getRoute(vehID)):
...
def changeSaveTimeAndSpeed(Visited, ListVeh, time, speed, ListVisited, vehID, ListTravelTime):
    ...
    if (Visited[ListVeh.index(vehID)] != traci.vehicle.getRoadID(vehID)) and (
                traci.vehicle.getRoadID(vehID) in traci.vehicle.getRoute(vehID)):
