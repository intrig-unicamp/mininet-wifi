...
static int handle_survey_noise(struct nl80211_state *state,
			      struct nl_cb *cb,
			      struct nl_msg *msg,
			      int argc, char **argv,
			      enum id_input id)
...
COMMAND(survey, noise, "noise <noise>",
	NL80211_CMD_GET_SURVEY, NLM_F_DUMP, CIB_NETDEV, handle_survey_noise,
	"List all gathered channel survey data");
