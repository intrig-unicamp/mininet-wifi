...
void parse_bitratee(struct nlattr *bitrate_attr, char *buf, int buflen)
{
	int rate = 0;
	char *pos = buf;
...
COMMAND(mobility, get, "<MAC address>",
	NL80211_CMD_GET_STATION, 0, CIB_STA, handle_station_get,
	"Get information for a specific station.");
COMMAND(mobility, del, "<MAC address>",
	NL80211_CMD_DEL_STATION, 0, CIB_STA, handle_station_get,
...
COMMAND_ALIAS(mobility, set, "<MAC address> plink_action <open|block>",
	NL80211_CMD_SET_STATION, 0, CIB_STA, handle_station_set_plink,
...
COMMAND_ALIAS(mobility, set, "<Positiion x,y,z> vlan <ifindex>",
	NL80211_CMD_SET_STATION, 0, CIB_STA, handle_station_set_vlan,
...
COMMAND_ALIAS(mobility, set, "<Distance (Meters)> mesh_power_mode "
	"<active|light|deep>", NL80211_CMD_SET_STATION, 0, CIB_STA,
...
COMMAND(mobility, dump, NULL,
	NL80211_CMD_GET_STATION, NLM_F_DUMP, CIB_STA, handle_station_dump,
...
COMMAND(mobility, set, NULL,
	NL80211_CMD_GET_SURVEY, NLM_F_DUMP, CIB_STA, handle_survey_dump,
	"List aall gathered channel survey data");
