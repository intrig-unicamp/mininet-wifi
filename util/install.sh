...
# Mininet-WiFi install script for Ubuntu (and Debian Wheezy+)
...
function wifi_deps {
    ...
    $install wireless-tools python3-scipy pkg-config python3-matplotlib libnl-3-dev libnl-genl-3-dev libssl-dev make libevent-dev patch
