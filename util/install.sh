...
function mn_deps {
    ...
    if [ "$DIST" = "Fedora" -o "$DIST" = "RedHatEnterpriseServer" ]; then
        $install gcc make socat psmisc xterm openssh-clients iperf \
            ...
            ethtool help2man pyflakes pylint python-pep8 python-pexpect python-typing
	elif [ "$DIST" = "SUSE LINUX"  ]; then
		$install gcc make socat psmisc xterm openssh iperf \
			iproute telnet python-setuptools libcgroup-tools \
			ethtool help2man python-pyflakes python3-pylint python-pep8 python-pexpect python-typing
    else
        $install gcc make socat psmisc xterm ssh iperf iproute telnet \
            python-setuptools cgroup-bin ethtool help2man \
            pyflakes pylint pep8 python-pexpect python-typing
    fi
